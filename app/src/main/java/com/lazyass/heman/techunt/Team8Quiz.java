...
public class Team8Quiz extends AppCompatActivity {

    QuestionAnswer[] array=new QuestionAnswer[]{
            new QuestionAnswer(R.string.question81,'b',R.string.answer811,R.string.answer812,R.string.answer813,R.string.answer814),
            new QuestionAnswer(R.string.question82,'c',R.string.answer821,R.string.answer822,R.string.answer823,R.string.answer824),
            new QuestionAnswer(R.string.question83,'d',R.string.answer831,R.string.answer832,R.string.answer833,R.string.answer834),
            new QuestionAnswer(R.string.question84,'b',R.string.answer841,R.string.answer842,R.string.answer843,R.string.answer844),
            new QuestionAnswer(R.string.question85,'b',R.string.answer851,R.string.answer852,R.string.answer853,R.string.answer854)
    };
    LocQuestionAnswer[] locArray=new LocQuestionAnswer[]
            {
                    new LocQuestionAnswer(R.string.questionL81,7258),
                    new LocQuestionAnswer(R.string.questionL82,3369),
                    new LocQuestionAnswer(R.string.questionL83,3364),
                    new LocQuestionAnswer(R.string.questionL84,2485),
                    new LocQuestionAnswer(R.string.questionL85,5195)
            };
    ...
    DatabaseReference child=root.child("Team8");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText(R.string.question81);
        r1.setText(R.string.answer811);
        r2.setText(R.string.answer812);
        r3.setText(R.string.answer813);
        r4.setText(R.string.answer814);
