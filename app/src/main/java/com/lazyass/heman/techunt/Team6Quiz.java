...
public class Team6Quiz extends AppCompatActivity {

    QuestionAnswer[] array=new QuestionAnswer[]{
            new QuestionAnswer(R.string.question61,'d',R.string.answer611,R.string.answer612,R.string.answer613,R.string.answer614),
            new QuestionAnswer(R.string.question62,'b',R.string.answer621,R.string.answer622,R.string.answer623,R.string.answer624),
            new QuestionAnswer(R.string.question63,'d',R.string.answer631,R.string.answer632,R.string.answer633,R.string.answer634),
            new QuestionAnswer(R.string.question64,'d',R.string.answer641,R.string.answer642,R.string.answer643,R.string.answer644),
            new QuestionAnswer(R.string.question65,'a',R.string.answer651,R.string.answer652,R.string.answer653,R.string.answer654)
    };
    LocQuestionAnswer[] locArray=new LocQuestionAnswer[]
            {
                    new LocQuestionAnswer(R.string.questionL61,7901),
                    new LocQuestionAnswer(R.string.questionL62,4179),
                    new LocQuestionAnswer(R.string.questionL63,7258),
                    new LocQuestionAnswer(R.string.questionL64,3369),
                    new LocQuestionAnswer(R.string.questionL65,3364)
            };
    ...
    DatabaseReference child=root.child("Team6");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText(R.string.question61);
        r1.setText(R.string.answer611);
        r2.setText(R.string.answer612);
        r3.setText(R.string.answer613);
        r4.setText(R.string.answer614);
