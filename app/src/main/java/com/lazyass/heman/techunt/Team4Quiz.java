...
public class Team4Quiz extends AppCompatActivity {

    QuestionAnswer[] array=new QuestionAnswer[]{
            new QuestionAnswer(R.string.question41,'d',R.string.answer411,R.string.answer412,R.string.answer413,R.string.answer414),
            new QuestionAnswer(R.string.question42,'b',R.string.answer421,R.string.answer422,R.string.answer423,R.string.answer424),
            new QuestionAnswer(R.string.question43,'d',R.string.answer431,R.string.answer432,R.string.answer433,R.string.answer434),
            new QuestionAnswer(R.string.question44,'a',R.string.answer441,R.string.answer442,R.string.answer443,R.string.answer444),
            new QuestionAnswer(R.string.question45,'d',R.string.answer451,R.string.answer452,R.string.answer453,R.string.answer454)
    };
    LocQuestionAnswer[] locArray=new LocQuestionAnswer[]
            {
                    new LocQuestionAnswer(R.string.questionL41,8932),
                    new LocQuestionAnswer(R.string.questionL42,2485),
                    new LocQuestionAnswer(R.string.questionL43,5253),
                    new LocQuestionAnswer(R.string.questionL44,5195),
                    new LocQuestionAnswer(R.string.questionL45,6124)
            };
    ...
    DatabaseReference child=root.child("Team4");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText(R.string.question41);
        r1.setText(R.string.answer411);
        r2.setText(R.string.answer412);
        r3.setText(R.string.answer413);
        r4.setText(R.string.answer414);
