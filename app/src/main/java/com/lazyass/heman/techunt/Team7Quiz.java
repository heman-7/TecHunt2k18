...
public class Team7Quiz extends AppCompatActivity {

    QuestionAnswer[] array=new QuestionAnswer[]{
            new QuestionAnswer(R.string.question71,'a',R.string.answer711,R.string.answer712,R.string.answer713,R.string.answer714),
            new QuestionAnswer(R.string.question72,'d',R.string.answer721,R.string.answer722,R.string.answer723,R.string.answer724),
            new QuestionAnswer(R.string.question73,'d',R.string.answer731,R.string.answer732,R.string.answer733,R.string.answer734),
            new QuestionAnswer(R.string.question74,'b',R.string.answer741,R.string.answer742,R.string.answer743,R.string.answer744),
            new QuestionAnswer(R.string.question75,'c',R.string.answer751,R.string.answer752,R.string.answer753,R.string.answer754)
    };
    LocQuestionAnswer[] locArray=new LocQuestionAnswer[]
            {
                    new LocQuestionAnswer(R.string.questionL71,6124),
                    new LocQuestionAnswer(R.string.questionL72,9248),
                    new LocQuestionAnswer(R.string.questionL73,7258),
                    new LocQuestionAnswer(R.string.questionL74,2344),
                    new LocQuestionAnswer(R.string.questionL75,5253)
            };
    ...
    DatabaseReference child=root.child("Team7");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText(R.string.question71);
        r1.setText(R.string.answer711);
        r2.setText(R.string.answer712);
        r3.setText(R.string.answer713);
        r4.setText(R.string.answer714);
