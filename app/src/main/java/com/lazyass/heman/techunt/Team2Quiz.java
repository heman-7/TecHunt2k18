package com.lazyass.heman.techunt;
...
public class Team2Quiz extends AppCompatActivity {

    QuestionAnswer[] array=new QuestionAnswer[]{
            new QuestionAnswer(R.string.question21,'b',R.string.answer211,R.string.answer212,R.string.answer213,R.string.answer214),
            new QuestionAnswer(R.string.question22,'b',R.string.answer221,R.string.answer222,R.string.answer223,R.string.answer224),
            new QuestionAnswer(R.string.question23,'d',R.string.answer231,R.string.answer232,R.string.answer233,R.string.answer234),
            new QuestionAnswer(R.string.question24,'b',R.string.answer241,R.string.answer242,R.string.answer243,R.string.answer244),
            new QuestionAnswer(R.string.question25,'d',R.string.answer251,R.string.answer252,R.string.answer253,R.string.answer254)
    };
    LocQuestionAnswer[] locArray=new LocQuestionAnswer[]
            {
                    new LocQuestionAnswer(R.string.questionL21,5195),
                    new LocQuestionAnswer(R.string.questionL22,6124),
                    new LocQuestionAnswer(R.string.questionL23,9248),
                    new LocQuestionAnswer(R.string.questionL24,7901),
                    new LocQuestionAnswer(R.string.questionL25,4179)
            };
    ...
    DatabaseReference child=root.child("Team2");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText(R.string.question21);
        r1.setText(R.string.answer211);
        r2.setText(R.string.answer212);
        r3.setText(R.string.answer213);
        r4.setText(R.string.answer214);
